...
public abstract class AbstractController {
    ...
    protected ResponseEntity<ErrorResponseEntity> generateExternalApiErrorResponseEntity(String errorMsg) {
    ...
    protected ResponseEntity<ErrorResponseEntity> generateParameterErrorResponseEntity(String errorMsg) {
    ...
    protected SuccessResponseEntity generateSuccessResponseEntity(HttpStatus status, String result) {
        return new SuccessResponseEntity(status.value(), result);
    }

    protected ErrorResponseEntity generateErrorResponseBody(int status, String error, String message) {
